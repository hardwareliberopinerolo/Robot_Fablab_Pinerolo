...
void setup()
{
  ...
  servo_1.attach(5); // Asocia el servo_1 al pin digital 5
  servo_2.attach(11); // Asocia el servo_2 al pin digital 11
  servo_3.attach(12); // Asocia el servo_3 al pin digital 12
