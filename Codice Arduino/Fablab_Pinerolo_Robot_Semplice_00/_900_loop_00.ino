...
//---> Gestione Movimento Manuale Robot
...
// ---> Gestione Movimento Automatico Robot
/*
...
// ---> Gestione Pulsante D4 Pausa
/*
// Bucle de espera hasta que se presione el botón de pausa...
  while (digitalRead(4) == false) //orginale
  //while (digitalRead(4) == true) //GB
  {
    Serial.print(".");
